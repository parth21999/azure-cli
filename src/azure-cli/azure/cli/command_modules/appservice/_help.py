...
examples:
  ...
  - name: for non-PowerShell users, turn on "alwaysOn" through a json with content '{"alwaysOn", true}'
    text: >
        az functionapp config set -g MyResourceGroup -n MyFunctionApp --generic-configurations '{"alwaysOn": true}'
...
examples:
  - name: assign local identity and assign a reader role to the current resource group.
    text: >
        az staticwebapp identity assign -g MyResourceGroup -n MyStaticWebApp --role reader --scope /subscriptions/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx/MyResourceGroup
  - name: enable identity for the web app.
    text: >
        az staticwebapp identity assign -g MyResourceGroup -n MyStaticWebApp
  - name: assign local identity and a user assigned identity to a function app.
    text: >
        az staticwebapp identity assign -g MyResourceGroup -n MyStaticWebApp --identities [system] myAssignedId
"""
...
examples:
  - name: Disable web app's system managed identity
    text: az staticwebapp identity remove --name MyStaticWebApp --resource-group MyResourceGroup
    crafted: true
  - name: Disable web app's system managed identity and a user managed identity
    text: az staticwebapp identity remove --name MyStaticWebApp --resource-group MyResourceGroup --identities [system] myAssignedId
"""
...
short-summary: display web app's managed service identity
examples:
  - name: display staticwebapp's managed service identity (autogenerated)
    text: az staticwebapp identity show --name MyStaticWebApp --resource-group MyResourceGroup
    crafted: true
"""
