...
def load_command_table(self, _):
    ...
    with self.command_group('staticwebapp', custom_command_type=staticsite_sdk, is_preview=True) as g:
        ...
        g.custom_command('identity assign', 'assign_identity', supports_no_wait=True)
        g.custom_command('identity remove', 'remove_identity', supports_no_wait=True)
        g.custom_command('identity show', 'show_identity', supports_no_wait=True)
